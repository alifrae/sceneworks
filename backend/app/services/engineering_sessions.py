"""Provider-neutral direct engineering sessions (WP14-WP18).
...
WP17 adds observation-only GUI evidence; WP18 adds separately permissioned
managed-PCS accessibility automation.
"""
